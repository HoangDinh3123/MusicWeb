<script setup>
    ...
    const deleteConfirm = (id) => {
        ...
        .then(() => {
            emits('update');
            alertStore.successAlert('Đã xóa playlist thành công');
        })
        .catch(error => {
...
<template>
    ...
    >
        ...
        <div class=" text-center">
            <p>Bạn có muốn xóa playlist này?</p>
        </div>
        <div class="mt-[40px] flex justify-center ">
            ...
            <button @click="deleteConfirm(id)" class="w-[120px] h-[40px] ml-[25px] rounded-md bg-[#f44336] text-white">Xóa</button>
        </div>
        </div>
